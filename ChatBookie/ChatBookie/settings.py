"""
Django settings for ChatBookie project.
...
SECRET_KEY = 'django-insecure-od%a^s4jg&etxq3*+^8c3ekmv#g65n*6^)=z-#*g+0h-px$c@w'
...
WSGI_APPLICATION = 'ChatBookie.wsgi.application'
